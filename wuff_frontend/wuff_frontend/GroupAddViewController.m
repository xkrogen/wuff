...
//  wuff_frontend
//
//  Created by Darren Tsung on 3/31/14.
...
- (void)viewDidLoad
{
    ...
    navigationBarItem = [[UINavigationItem alloc] initWithTitle:@"Create Group"];
    
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithTitle:@"Back" style:UIBarButtonItemStylePlain target:self action:@selector(back)];
    [backButton setTintColor:[UIColor whiteColor]];
    [backButton setAccessibilityLabel:@"Group Add Back Button"];
